...
// 
// PLANNING: Lämpligt nu är väl att ha en Helper som kan ge en länksamling med flaggor utifrån de språk som finns i systemet. 
//  -Det finns två varianter, en som byter språk på den sida man är på, den listar alltså alla språk som den sidan finns i.
//   Den andra varianten listar samtliga språk sajten har sidor i. 
//   Sedan är det väl dags att uppdatera edit-sidan, så man dels kan byta språk,
//   dels se en lista på språk sidan ännu inte finns i. (utifrån den sajt-globala språklistan ovan)
//   -Det finns en settings-sida nånstans, där man kan lägga till språk. När man lägger till ett språk så lägger man egentligen bara till
//    main-sidan på det språket, sen sköter de två funktionerna ovan resten. (Ingen settings fil för detta alltså.)
// 
// (En settings-sida bör också ha en subsida där man byter användarnamn och lösenord på sitt konto, men det kan vi ta sen.)
// 

/* A probably pretty comprehensive list of languages and their i18n codes. 
 *
 * Language code source: https://gist.github.com/pjc-is/49971b36db38fdeae6fc
 * 
 */
